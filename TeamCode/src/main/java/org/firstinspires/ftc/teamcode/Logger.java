...
public class Logger {
    ...
    public Logger open(String filename) {
    ...
    public Logger add(String fmt, Object... args) {
    ...
    public Logger add(VoltageSensor vs) {
